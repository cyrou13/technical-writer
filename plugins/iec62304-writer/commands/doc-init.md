...
# refresh_items.py — overwrite uniquement si --update
if [ ! -f tools/refresh_items.py ] || [ "$UPDATE" = "1" ]; then
  cp "${CLAUDE_PLUGIN_ROOT}/scaffold/tools/refresh_items.py" tools/refresh_items.py
  CREATED+=("tools/refresh_items.py")
else
